      ...
      <ul className="m-0 p-0">
        <li className={style.sidebarList}>
          <NavLink className="without-active" to={"/farmer/dashboard"}>
            ...
            <h6 className={style.h6}>Dashboard</h6>
          </NavLink>
        </li>
        <li className={style.sidebarList}>
        ...
        <li className={style.sidebarList}>
          <NavLink className="without-active" to={"/farmer/follower"}>
            ...
            <h6 className={style.h6}>Follower</h6>
          </NavLink>
        </li>
        ...
        <li className={style.sidebarList}>
          <NavLink className="without-active" to={"/farmer/inbox"}>
            ...
            <h6 className={style.h6}> Inbox</h6>
          </NavLink>
        </li>

        <li className={style.sidebarList} id={style.logout}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
