...
const Otp = () => {
    ...
    const [inpval,setinpval] = useState({inp1:'',inp2:'',inp3:'',inp4:''})
  ...
  if (inputLength === 0) {
    ...
    const handlesubmit= async (e)=>{
      ...
      const verifieduser = await axios.post('register/otp-verification',{'otp':otp,'email':email})
  ...
  return (
    ...
    <h1 className={logincss.mainhead} >Otp verification</h1>
     ...
     <div id={otpcss.inpdivflex}>
      ...
      <input type="number" name='inp1' value={inpval.inp1} inputMode="numeric" onChange={(e)=>handlechang(e)} maxLength={1} className={`${otpcss.inp} col-2 col-sm-1`} />
      <input type="number"  name='inp2' value={inpval.inp2}  onChange={(e)=>handlechang(e)}  maxLength={1} className={`${otpcss.inp} col-2 col-sm-1`}  />
      <input type="number"  name='inp3' value={inpval.inp3}  onChange={(e)=>handlechang(e)} maxLength={1}  className={`${otpcss.inp} col-2 col-sm-1`} />
      <input type="number"  name='inp4' value={inpval.inp4}  onChange={(e)=>handlechang(e)} maxLength={1}  className={`${otpcss.inp} col-2 col-sm-1`} />
     
     </div>
     {error && <h5 className={otpcss.error}>{error}</h5>}
     
     <div className='m-auto text-center'style={{paddingTop:'94px'}}>
      <button type='submit' className={logincss.button}>Verifiy</button></div>
